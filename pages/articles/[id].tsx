...
export const articlesData: { [key: string]: Article } = {
  ...
  article3: {
    ...
    images: ['/images/article3-1.png', '/images/article3-2.png']
  },
  article4: {
  ...
  article5: {
    ...
    images: ['/images/article5-1.png', '/images/article5-2.png']
  },
  article6: {
    ...
    images: ['/images/article6-1.png', '/images/article6-2.png']
  },
};
